...
mysql_output=$(mysql -u root -proot -e "USE bitcoin_data; \
    INSERT INTO binancecoin_detail (current_rate, timestamp) VALUES ('$current_rate', NOW()); \
    SET @last_id = LAST_INSERT_ID(); \
    INSERT INTO binancecoin_details (binancecoin_price_id, low_rate, high_rate) VALUES (@last_id, '$low_rate', '$high_rate');" 2>&1)
